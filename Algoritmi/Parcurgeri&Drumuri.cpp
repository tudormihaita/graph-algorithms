...
public:
	...
	//ALTI ALGORITMI - CEL MAI SCURT DRUM / NUMAR COMPONENTE TARE CONEXE
	void Moore(int src, int dest);
	void Kosaraju();

	//ALGORITMI DRUMURI DE COST MINIM
...
Graph::Graph(string input, string output) {
	this->input = input;
	this->output = output;
...
int main() {
	Graph G("in-ParcurgeriDrumuri.txt", "out-ParcurgeriDrumuri.txt");
